...
import { BarChart3, Building2, BriefcaseBusiness, Download, Layers3, LogOut, SearchCheck } from "lucide-react";
...
const cards = [
  ...
  { href: "/admin/sourcing", title: "咕咕寻访模式", copy: "查看真实公司、私密画像、优先级与相似岗位", icon: SearchCheck },
];
