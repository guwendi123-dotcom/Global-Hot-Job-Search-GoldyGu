...
- 当前正式版本：`c9d81f4e-286f-4bc0-844d-f63183a8728c`
...
- 完成岗位发现体系 2+4 方案：公开端按职能与专业方向组合筛选，首页同步使用新版职能分类；后台新增私密寻访工作台及 `admin:role-profiles` 数据接口，首批 12 份内部画像已写入受保护的 Cloudflare KV。方案 3（候选人画像入口）暂未实施。
