...
- 当前正式版本：`9c5741b1-9af4-4c58-8274-0770d32897f3`
- 当前公开数据：43 家公司、212 个岗位、7 个行业

## 当前产品能力

- 首页按“编辑精选 + 最近 30 天访问热度 + 逐日衰减的新鲜度”综合排序，新岗位、近期高热岗位及明确要求首页展示的高优岗位优先。
...
- 隐私优先 AI 对话平台：“增长负责人”为 `Offer 阶段`；搜索与答案引擎负责人、创作者生态与社区负责人、创作者合作与联盟营销负责人、后端工程师（Agent 方向）、Coding Agent 研发工程师共 5 个岗位开放。前三个增长岗位优先旧金山湾区并接受 Remote；两个工程岗位为全球 Remote。
- AI 动画创作工具：网站现有 5 个岗位均因业务方向调整暂停招聘，岗位记录继续保留。
- 全球内容社区 Trust & Safety：前三个岗位 Base Palo Alto；Policy Specialist 为旧金山湾区 / 新加坡，四个岗位均不含纽约。
- 全球主动式 AI 生活平台：上海 Agent 后端、数据开发负责人、工程效能、安全和后训练算法 5 个技术岗位持续招聘；纽约新增线下市场与社区运营协调员。前四个技术岗为当前高优，后训练算法长期优中择优。安全岗细分 Scope 仍需客户进一步确认，未确认前不得向候选人承诺。
- AI 模型训练数据与任务环境基础设施：已上线 10 个国内 On-site 全职岗位，覆盖算法研究、多模态 Agent 后训练、Agent 基建、后训练数据算法、模型评测、游戏开发、平台产品、游戏产品、数据策略产品与专家平台运营；文档中的已关闭岗位、实习与兼职岗位未上线。
...
- 全球领先数字科技与 AI 平台：保留美国 AI 技术一号位，并新增科技方向新媒体策略、医疗大健康新媒体传播、财富保险公关、国际传播社交媒体经理 4 个中国岗位；目标公司、招聘周期与内部筛选偏好只保存在私密寻访画像中。
- 全球化旅游平台：新增深圳“交通业务产品负责人”，覆盖全球交通全品类、交易履约、供应链中台、AI 产品化及产品团队管理；岗位为高优，并已进入首页精选。
- 全球化 AI Native 产品公司：新增 AI 产品经理岗位，公开页面按要求隐藏真实公司、产品、主体、投资方、融资金额和具体城市；行业背景不限，AI / LLM / Agent 经历仅为加分项，私密画像保留真实身份与完整寻访口径。
